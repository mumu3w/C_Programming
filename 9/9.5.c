...
void create_magic_square(int n, int magic_square[ARRAY_MAX][ARRAY_MAX]);
void print_magic_square(int n, int magic_square[ARRAY_MAX][ARRAY_MAX]);

int main(){
	int magic_square[ARRAY_MAX][ARRAY_MAX] = {{0}}, n;
